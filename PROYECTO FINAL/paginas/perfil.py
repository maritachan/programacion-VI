...
def perfil_page(page: ft.Page, user_data):
    ...
    edad = ft.TextField(label="Edad", value=str(user_data.get("edad", "")), width=250, keyboard_type=ft.KeyboardType.NUMBER)
    peso = ft.TextField(label="Peso (kg)", value=str(user_data.get("peso", "")), width=250, keyboard_type=ft.KeyboardType.NUMBER)
    altura = ft.TextField(label="Altura (cm)", value=str(user_data.get("altura", "")), width=250, keyboard_type=ft.KeyboardType.NUMBER)
