...
def sugerencia_del_dia_container():
    ...
    return ft.Container(
        ...
        content=ft.Column(
            spacing=5,
            controls=[
                ft.Text("💡 Sugerencia del Día", size=13, weight=ft.FontWeight.BOLD, color=ft.Colors.WHITE),
...
# PÁGINA PRINCIPAL
# ================================
def menu_view(page: ft.Page, user_data):
    page.title = "MiRutina - Menú Principal"
    page.bgcolor = ft.Colors.BLACK

    # Función para actualizar nombre dinámico
    def update_ui():
                    ...
                    content=ft.Row(
                        ...
                        controls=[
                            ft.IconButton(
                                ...
                                icon_color="#38BDF8",
                                icon_size=32,
                                on_click=lambda e: page.go("/resumen"),
                            ),
                        ],
                    ),
                ),
